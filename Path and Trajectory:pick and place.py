...
q3=np.array([deg_to_rad(float(-90)),
             (float(50))/100,
             (float(0)),]
             )


q4=np.array([deg_to_rad(float(-90)),
             (float(50))/100,
             (float(40))/100,]
             )
...
q6=np.array([deg_to_rad(float(90)),
             (float(40))/100,
             (float(0)),]
             )
...
q8=np.array([deg_to_rad(float(45)),
             (float(10)/100),
             (float(0)),]
             )


q9=np.array([deg_to_rad(float(45)),
             (float(10)/100),
             (float(40)/100),]
             )
...
Cylindrical.plot(traj9.q,limits=[x1,x2,y1,y2,z1,z2])
Cylindrical.plot(traj10.q,limits=[x1,x2,y1,y2,z1,z2])
